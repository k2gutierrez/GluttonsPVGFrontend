    ...
    <section className="awareness-grid">
      ...
      <Panel className="register-panel p-6 md:p-8">
        ...
        {done ? <div className="success-terminal"><span>STATUS::REGISTERED</span><strong>WALLET RECEIVED.</strong><p>Watch @GluttonGame for the next signal.</p></div> : <div className="register-steps">
          <div className="step-row"><span>01</span><div><b>FOLLOW @GLUTTONGAME</b><small>Opens X in a new tab.</small><a data-fx-sound href={SITE.xUrl} target="_blank" rel="noopener noreferrer" onClick={() => setFollowed(true)} className="ghost-btn block text-center">FOLLOW ON X ↗</a></div></div>
