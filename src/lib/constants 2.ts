...
export const GAME_ENGINE_ABI = [
  ...
  { type: 'function', name: 'GAME_HOUR', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
  { type: 'function', name: 'currentPhaseCode', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint8' }] },
  { type: 'function', name: 'lastSupperWarningAt', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
  { type: 'function', name: 'lastSupperAt', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
  { type: 'function', name: 'lastSupperPopulationThreshold', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'trucePopulationThreshold', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  ...
  { type: 'function', name: 's_truceEpoch', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 's_truceVotes', stateMutability: 'view', inputs: [{ name: 'tokenId', type: 'uint256' }], outputs: [{ name: 'epoch', type: 'uint256' }, { name: 'ownerAtVote', type: 'address' }] },
  { type: 'function', name: 's_tiebreakCandidate', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 's_lastDeathTimestamp', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
